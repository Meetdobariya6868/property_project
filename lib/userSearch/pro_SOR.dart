...
class Project_SOR_Search extends StatefulWidget {
  final String pn;
  const Project_SOR_Search({Key? key, required this.pn}) : super(key: key);

  @override
  State<Project_SOR_Search> createState() => _Project_SOR_SearchState();
}

class _Project_SOR_SearchState extends State<Project_SOR_Search> {
    ...
    return Container(
      child: StreamBuilder<QuerySnapshot>(
          stream: (widget.pn != "" && widget.pn != null)
              ...
              .instance
              .collection("propertyDetails")
              .where('sellOrRent', isEqualTo: widget.pn)
              .snapshots()
