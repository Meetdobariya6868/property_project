...
class Project_Status_Search extends StatefulWidget {
  final String pn;
  const Project_Status_Search({Key? key, required this.pn}) : super(key: key);

  @override
  State<Project_Status_Search> createState() => _Project_Status_SearchState();
}

class _Project_Status_SearchState extends State<Project_Status_Search> {
    ...
    return Container(
      child: StreamBuilder<QuerySnapshot>(
          stream: (widget.pn != "" && widget.pn != null)
              ...
              .instance
              .collection("propertyDetails")
              .where('status', isEqualTo: widget.pn)
              .snapshots()
