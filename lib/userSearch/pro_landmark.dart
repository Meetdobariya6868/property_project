...
class Project_Landmark_Search extends StatefulWidget {
  final String pn;
  const Project_Landmark_Search({Key? key, required this.pn}) : super(key: key);

  @override
  State<Project_Landmark_Search> createState() => _Project_Landmark_SearchState();
}

class _Project_Landmark_SearchState extends State<Project_Landmark_Search> {
    ...
    return Container(
      child: StreamBuilder<QuerySnapshot>(
          stream: (widget.pn != "" && widget.pn != null)
              ...
              .instance
              .collection("propertyDetails")
              .where('landmark', isEqualTo: widget.pn)
              .snapshots()
