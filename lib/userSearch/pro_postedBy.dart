...
class Project_PostedBy_Search extends StatefulWidget {
  final String pn;
  const Project_PostedBy_Search({Key? key, required this.pn}) : super(key: key);

  @override
  State<Project_PostedBy_Search> createState() => _Project_PostedBy_SearchState();
}

class _Project_PostedBy_SearchState extends State<Project_PostedBy_Search> {
    ...
    return Container(
      child: StreamBuilder<QuerySnapshot>(
          stream: (widget.pn != "" && widget.pn != null)
              ...
              .instance
              .collection("propertyDetails")
              .where('postedBy', isEqualTo: widget.pn)
              .snapshots()
