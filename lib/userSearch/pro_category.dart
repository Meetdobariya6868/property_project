...
class Project_Category_Search extends StatefulWidget {
  ...
  @override
  State<Project_Category_Search> createState() => _Project_Category_SearchState();
}
                ...
                return GestureDetector(
                  onTap: () {
                    // FirebaseFirestore.instance.collection("propertyDetails").get().then((value) => {
                      ...
                      // Navigator.push(context, MaterialPageRoute(builder: (context) => propertyDetail(value: id, u2: '', v1: ' ',)))
                    // });
                  },
                  child: Container(
